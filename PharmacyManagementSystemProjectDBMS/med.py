...
class Pharmacy:
    def __init__(self, root):
        ...
        self.root.geometry("1430x740+0+0")
        self.root.resizable(False, False)
        self.root.iconbitmap("images/doc.ico")
        ...
        self.heading = Label(self.root, text=self.txt, font=(
            "Lora", 30, "bold"), bg='#e6e600', fg="blue", bd=9, relief=RIDGE)
        self.heading.pack(side=TOP, fill=X)
        self.slider()
        self.heading_color()

        ######### pharmacy logo label #######
        img1 = Image.open("image/new.png")
        img1 = img1.resize((50, 35), Image.LANCZOS)
        ...
        ###### Top Frame #####
        topframe = Frame(self.root, bg='black', bd=10, relief=RIDGE, padx=20)
        topframe.place(x=0, y=62, width=1430, height=400)

        ########  down button frame #######
        down_buttonframe = Frame(
            self.root, bg='#8600b3', bd=10, relief=RIDGE, padx=20)
        down_buttonframe.place(x=0, y=462, width=1430, height=60)

        ###### all buttons ######
        add_button = Button(down_buttonframe, text="Add Medicine", command=self.addmedicine, font=(
            "Fira Code", 13, "bold"), fg="white", bg="black", bd=1, width=150, relief=RIDGE, activebackground="black", activeforeground="white")
        add_button.grid(row=0, column=0)

        update_button = Button(down_buttonframe, command=self.update_new, text="Update", font=(
            "Fira Code", 13, "bold"), fg="white", bg="black", bd=4, width=150, relief=RIDGE, activebackground="black", activeforeground="white")
        update_button.grid(row=0, column=1)

        delete_button = Button(down_buttonframe, command=self.delete_new, text="Delete", font=(
            "Fira Code", 13, "bold"), fg="white", bg="black", bd=4, relief=RIDGE, activebackground="black", width=150, activeforeground="white")
        delete_button.grid(row=0, column=2)

        reset_button = Button(down_buttonframe, text="Reset", command=self.clear_new, font=("Fira Code", 13, "bold"),fg="white", bg="black", bd=4, relief=RIDGE, width=150, activebackground="black", activeforeground="white")
        reset_button.grid(row=0, column=3)

        exit_button = Button(down_buttonframe, command=self.root.quit, text="Exit", font=(
            "Fira Code", 13, "bold"),  fg="white", bg="black", width=150, bd=4, relief=RIDGE, activebackground="black", activeforeground="white")
        exit_button.grid(row=0, column=4)

        search_by = Label(down_buttonframe, text="Search By", font=(
            "Fira Code", 15, "bold"), fg="white", bg="black", bd=4, padx=3)
        search_by.grid(row=0, column=5, sticky=W)

        self.search_combo = ttk.Combobox(down_buttonframe, width=14, font=(
            "Fira Code", 12, "bold"), state="readonly", textvariable=self.search_by)
        self.search_combo["values"] = ("Select Options", "Ref No.")
        self.search_combo.grid(row=0, column=6)
        self.search_combo.current(0)

        entry_button = Entry(down_buttonframe, font=("Fira Code", 12, "bold"), fg="black",
                            bg="white", bd=4, relief=RIDGE, width=20, textvariable=self.search_txt)
        entry_button.grid(row=0, column=7)

        search_button = Button(down_buttonframe, text="Search", font=("Fira Code", 13, "bold"), fg="white", bg="black",
                    bd=4, relief=RIDGE, activebackground="black", activeforeground="white", command=self.search_data)
        search_button.grid(row=0, column=8)

        show_button = Button(down_buttonframe, text="Show All", font=("Fira Code", 13, "bold"), fg="white", bg="black",
                    bd=5, relief=RIDGE, activebackground="black", width=110, activeforeground="white", command=self.fetch_new)
        show_button.grid(row=0, column=9)

        ######## left small frame #######
        left_smallframe = LabelFrame(topframe, bg='#00b300', bd=15, relief=RIDGE,
                                    text="Medicine Information", font=("Fira Code", 20, "bold"), fg="white")
        left_smallframe.place(x=0, y=5, width=850, height=370)
        ...
        self.company_entry = Entry(left_smallframe, textvariable=self.companyname_var, width=24, font=(
            "Lora", 13, "bold"), fg="black", bg="white")
        ...
        font=("Fira Code", 18, "bold"), bg='#00b300', fg="white")
        save_bgg.place(x=370, y=120, width=400)

        ############ right frame #########
        right_frame = LabelFrame(topframe, bg='#2eb8b8', bd=10, relief=RIDGE, padx=5,
                                text="New Medicine Add department", font=("Fira Code", 21, "bold"), fg="white")
        right_frame.place(x=860, y=5, width=530, height=370)
        ...
        newframe = Frame(right_frame, bg='#00b300', bd=6, relief=RIDGE)
        newframe.place(x=265, y=160, width=123, height=160)

        ###### button in this frame ###
        add_button = Button(newframe, text="Add", font=("Fira Code", 13, "bold"), width=100, fg="white", bg="black",
                            bd=5, command=self.AddMed, relief=RIDGE, activebackground="black", activeforeground="white")
        add_button.grid(row=0, column=0)

        updatenew_button = Button(newframe, text="Update", font=("Fira Code", 13, "bold"), width=100, fg="white",
                                bg="black", bd=5, command=self.Update_med, relief=RIDGE, activebackground="black", activeforeground="white")
        updatenew_button.grid(row=1, column=0)

        delnew_button = Button(newframe, text="Delete", font=("Fira Code", 13, "bold"), width=100, fg="white", bg="black",
                            bd=5, relief=RIDGE, activebackground="black", activeforeground="white", command=self.Delete_med)
        delnew_button.grid(row=2, column=0)

        clr_button = Button(newframe, text="Clear", command=self.clear_med, font=("Fira Code", 13, "bold"), width=100,
        ...
        side_frame = Frame(right_frame, bd=4, relief=RIDGE, bg="black")
        ...
        self.medicine_table.column("ref", width=105)
        self.medicine_table.column("medname", width=105)
        ...
        down_frame.place(x=0, y=522, width=1430, height=212)

        ########## scrollbar in down frame ########
        scroll_frame = Frame(down_frame, bd=2, relief=RIDGE, bg="white")
        scroll_frame.place(x=0, y=0, width=1430, height=192)
    ...
    def Update_med(self):
        ...
        if self.ref_variable.get() == "" or self.addmed_variable.get() == "":
            ...
            try:
                ...
                conn.commit()
                messagebox.showinfo(
                    "Update", "Successfully Updated", parent=self.root)
                self.fetch_datamed()
                conn.close()
    ...
    def Delete_med(self):
        if self.ref_variable.get() == "":
            messagebox.showerror(
                "Error", "Ref no is required", parent=self.root)
        else:
            ...
            try:
                ...
                my_cursor.execute(
                    "Delete from pharma where Ref_no=? ", (self.ref_variable.get(),))
                conn.commit()
                messagebox.showinfo(
    ...
    def delete_new(self):
        if self.refno_var.get() == "":
            ...
            try:
                ...
                my_cursor.execute(
                    "Delete from Information where REF_NO=? ", (self.refno_var.get(),))
                conn.commit()
                messagebox.showinfo(
                    "Delete", "Successfully Deleted", parent=self.root)
                self.fetch_new()
    ...
    def search_data(self):
        ...
        if selected == "Select Options":
            ...
            new_cursor.execute(
                "Select * from Information where REF_NO=?", (self.search_txt.get(),))
